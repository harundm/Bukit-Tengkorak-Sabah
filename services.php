		...
		<div id="colorlib-main">
			<section class="ftco-section ftco-bread">
	          ...
	          <div class="col-md-8 ftco-animate">
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Virtual Tour</span></p>
	            <h1 class="bread">Virtual Tour</h1>
	          </div>
	        </div>
				</div>
			</section>
			...
			<div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
	                <h3 class="heading mb-3"><strong><a href="index.html" target="_blank">Indoor Virtual Tour</a></strong></h3>
	                <p></p>
	              </div>
	            </div>      
	          </div>
	            ...
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
	                <h3 class="heading mb-3"><strong><a href="https://www.google.com/maps/@4.4393563,118.6223241,2a,75y,249.65h,95.55t/data=!3m6!1e1!3m4!1sdOm5d5GUhef-DDmJZRuchg!2e0!7i13312!8i6656" target="_blank">Outdoor Virtual Tour</a></strong></h3>
	                <p></p>
	              </div>
	            </div>      
	          </div>
	          ...
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
	                <h3 class="heading mb-3"><strong><a href="https://forms.gle/pbkCAWN6JH4H4Zu37" target="_blank">Quizzes</a></strong></h3>
	                <p></p>
	              </div>
	            </div>    
	          </div>		
